...
aura_env.battleforazeroth = {
    ...
    leathers = {
        ...
        [4] = '168649', -- Dredged (8.2)
        [5] = '168650', -- Cragscale (8.2)
        [6] = '154722', -- Tempest Hide
        [7] = '153051', -- Mistscale
        [8] = '154165' -- Calcified Bone
    },
    disenchants = {
        [1] = '152875', -- Gloom Dust
    ...
    meats = {
        ...
        [5] = '168303', -- Rubbery Flank (8.2)
        [6] = '168645' -- Moist Fillet (8.2)
    },
    fishes = {
        ...
        [8] = '168302', -- Viper Fish (8.2)
        [9] = '168646', -- Mauve Stinger (8.2)
        [10] = '162516', -- Rasboralus
